...
namespace Ps2TtkCalculator.Shared.Census
{
    ...
    {
        private static readonly Uri baseCensusUri = new ("https://census.daybreakgames.com/s:b4rr/get/ps2:v2/");
        ...
        public static Uri GetWeaponFullRequestUri(int itemId)
        {
            ...
            string fireMode = "c:join=fire_mode^show:fire_mode_id'pellets_per_shot'muzzle_velocity'speed^inject_at:fire_mode";
